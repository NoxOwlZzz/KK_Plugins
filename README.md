...
For the opt-in Material Editor manifest schema 2 metadata, see the [schema 2 guide](Guides/Material%20Editor%20Guide/MANIFEST_SCHEMA_V2.md) and the [unified manifest template](Guides/Material%20Editor%20Guide/shader_manifest_template.xml).
